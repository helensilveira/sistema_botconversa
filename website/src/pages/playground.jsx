...
import Head from '@botconversa/Head';
...
export default function Playground() {
  ...
  React.useEffect(() => {
    ...
    setTimeout(() => {
      if (localStorage.getItem('botconversa-chat-config')) overwriteDefaultConfig();
  ...
  const recordConfig = () => {
    localStorage.setItem('botconversa-chat-config', JSON.stringify(playgroundConfig));
  };
  ...
  function overwriteDefaultConfig() {
    Object.assign(playgroundConfig, JSON.parse(localStorage.getItem('botconversa-chat-config')));
  }
  ...
  return (
    <Layout title="Playground" description="botconversa Chat Playground">
      <Head>
