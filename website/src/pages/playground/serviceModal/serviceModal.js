        ...
        <div className="playgroud-service-modal-form">
          ...
          {activeService === 'custom' && (
            <Required
              ...
              setValue={changeRequiredValue.bind(this, setRequiredValue)}
              title="URL:"
              link={'https://botConversa.dev/docs/connect#Request'}
            />
          )}
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// Utility here as botconversa SSR does not permit .js files that are not components
...
function getCodeStr(connect, isCustom, view, type) {
  if (connect.demo) {
    return `<botconversa-chat demo="true"></botconversa-chat>`;
  }
  if (connect.webModel) {
    return `<botconversa-chat ${
  ...
  if (isCustom) {
    ...
    return `<botconversa-chat${files} request='${JSON.stringify(connect['custom'], null, 2)}'></botconversa-chat>`;
  }
  ...
  return `<botconversa-chat${files} directConnection='${JSON.stringify(connect, null, 2)}'></botconversa-chat>`;
}
...
const REQUIRED_PARAMETERS_LINKS = {
  azure: {
    textToSpeech: 'https://botConversa.dev/docs/directConnection/Azure#TextToSpeech',
    speechToText: 'https://botConversa.dev/docs/directConnection/Azure#SpeechToText',
    summarization: 'https://botConversa.dev/docs/directConnection/Azure#Summarization',
  },
  huggingFace: {
...
const OPTIONAL_PARAM_TO_LINK = {
  demo: {demo: ''},
  custom: {
    method: 'https://botConversa.dev/docs/connect#Request',
    websocket: 'https://botConversa.dev/docs/connect#Websocket',
    headers: 'https://botConversa.dev/docs/connect#Request',
    additionalBodyProps: 'https://botConversa.dev/docs/connect#Request',
    allowImages: 'https://botConversa.dev/docs/files#images',
    allowCamera: 'https://botConversa.dev/docs/files#camera',
    allowGifs: 'https://botConversa.dev/docs/files#gifs',
    allowAudio: 'https://botConversa.dev/docs/files#audio',
    allowMicrophone: 'https://botConversa.dev/docs/files#microphone',
    allowMixedFiles: 'https://botConversa.dev/docs/files/#mixedFiles',
  },
  webModel: {
    model:
      'https://github.com/botconversa/painel/blob/4449a91e26bb86d1d3a45633fd49c4dead3293d4/component/src/types/webModel/webModel.ts#L1',
    instruction: 'https://botConversa.dev/docs/webModel#webModel',
  },
  openAI: {
    chat: {
      system_prompt: 'https://botConversa.dev/docs/directConnection/OpenAI#Chat',
    ...
    assistant: {
      assistant_id: 'https://botConversa.dev/docs/directConnection/OpenAI#Assistant',
      thread_id: 'https://botConversa.dev/docs/directConnection/OpenAI#Assistant',
      load_thread_history: 'https://botConversa.dev/docs/directConnection/OpenAI#Assistant',
      allowMixedFiles: 'https://botConversa.dev/docs/files/#mixedFiles',
    },
    images: {
  ...
  azure: {
    textToSpeech: {
      ...
      gender: 'https://botConversa.dev/docs/directConnection/Azure#TextToSpeech',
      outputFormat:
    ...
    translation: {
      region: 'https://botConversa.dev/docs/directConnection/Azure#Translation',
      language:
        'https://en.wikipedia.org/wiki/IETF_language_tag#:~:text=An%20IETF%20BCP%2047%20language,the%20IANA%20Language%20Subtag%20Registry.',
    },
  },
