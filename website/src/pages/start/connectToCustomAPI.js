  ...
  return (
    ...
    >
      <div className={`start-page-text start-page-large-text ${displayRequest ? 'start-page-main-details-visible' : ''}`}>
        ...
        <a href="https://botConversa.dev/docs/connect#request" target="_blank">
          request
        </a>{' '}
        property:
      </div>
      ...
      >
        The target service needs to be able to handle botconversa Chat's{' '}
        <a href="https://botConversa.dev/docs/connect" target="_blank">
          request
        </a>{' '}
        and{' '}
        <a href="https://botConversa.dev/docs/connect#Response" target="_blank">
          response
        </a>{' '}
        formats.
      </div>
      ...
      >
        - Add{' '}
        <a href="https://botConversa.dev/docs/interceptors" target="_blank">
          interceptor
        </a>{' '}
      ...
      >
        - Use a{' '}
        <a href="https://botConversa.dev/docs/connect#Handler" target="_blank">
          handler
        </a>{' '}
