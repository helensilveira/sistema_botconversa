...
// not in a utility file as botconversa reads it as a page
  ...
  return (
    ...
    >
      <div className="start-page-logo start-panel-logo">
        <a href="https://github.com/botconversa/painel/tree/main/example-servers/node/express" target="_blank">
          <img src={expressJSLogo} width="38" style={{paddingTop: 9}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://github.com/botconversa/painel/tree/main/example-servers/node/nestjs" target="_blank">
          <img src={nestJSLogo} width="38" style={{paddingTop: 10}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://github.com/botconversa/painel/tree/main/example-servers/java/springboot" target="_blank">
          <img src={springBootLogo} width="37" style={{paddingTop: 10.5}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://github.com/botconversa/painel/tree/main/example-servers/go" target="_blank">
          <img src={goLogo} width="26" style={{paddingTop: 10}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://github.com/botconversa/painel/tree/main/example-servers/python/flask" target="_blank">
          <img src={flaskLogo} width="37" style={{paddingTop: 8, transform: 'scaleX(0.95)'}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://github.com/botconversa/painel/tree/main/example-servers/nextjs" target="_blank">
...
function DirectLogos(props) {
  return (
    ...
    >
      <div className="start-page-logo start-panel-logo">
        <a href="https://botConversa.dev/docs/directConnection/OpenAI" target="_blank">
          <img src={openAILogo} width="34" style={{paddingTop: 11}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://botConversa.dev/docs/directConnection/HuggingFace" target="_blank">
          <img src={huggingFaceLogo} width="47" style={{paddingTop: 4}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://botConversa.dev/docs/directConnection/Cohere" target="_blank">
          <img src={cohereLogo} width="51" style={{paddingTop: 3}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://botConversa.dev/docs/directConnection/StabilityAI" target="_blank">
          <img src={stabilityAILogo} width="43" style={{paddingTop: 6}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://botConversa.dev/docs/directConnection/AssemblyAI" target="_blank">
          <img src={assemblyAILogo} width="33" style={{paddingTop: 11}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://botConversa.dev/docs/directConnection/Azure" target="_blank">
  ...
  return (
    ...
    >
      ...
      <div className={`start-page-text start-page-small-text ${displayDirect ? 'start-page-main-details-visible' : ''}`}>
        ...
        <a href="https://botConversa.dev/docs/directConnection/" target="_blank">
          directConnection
        </a>{' '}
        property:
      </div>
