  ...
  return (
    ...
    >
      <div className="start-page-logo start-panel-logo">
        <a href="https://botconversa.com/edit/botconversa-chat-react?file=src%2FApp.tsx" target="_blank">
          <img src={reactLogo} width="41" style={{paddingTop: 10}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://botConversa.dev/examples/frameworks/#vue" target="_blank">
          <img src={vueLogo} width="38" style={{paddingTop: 10}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://botConversa.dev/examples/frameworks#svelte" target="_blank">
          <img src={svelteLogo} width="32" style={{paddingTop: 8}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://botconversa.com/edit/botconversa-chat-angular?file=src%2Fapp%2Fapp.component.ts" target="_blank">
          <img src={angularLogo} width="50" style={{paddingTop: 1}} />
        </a>
      </div>
      <div className="start-page-logo start-panel-logo">
        <a href="https://botconversa.com/edit/botconversa-chat-solid?file=src%2FApp.tsx" target="_blank">
      ...
      <div className="start-page-logo start-panel-logo">
        <a href="https://codesandbox.io/s/botconversa-chat-vanillajs-v2ywnv?file=/index.html" target="_blank">
  ...
  return (
    ...
    >
      ...
      <div className={`start-page-text start-page-small-text ${displayInstall ? 'start-page-main-details-visible' : ''}`}>
        ...
        <a href="https://botConversa.dev/docs/installation" target="_blank">
          npm
        </a>{' '}
        dependency or a{' '}
        <a href="https://botConversa.dev/docs/installation" target="_blank">
