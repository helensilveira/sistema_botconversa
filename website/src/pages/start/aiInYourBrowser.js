...
export default function AIInyourBrowser(props) {
  ...
  return (
    ...
    >
      ...
      >
        1. Add the{' '}
        <a href="https://botConversa.dev/docs/webModel" target="_blank">
          botconversa-chat-web-llm
        </a>{' '}
        <a href="https://botConversa.dev/examples/externalModules" target="_blank">
          external module
        </a>
        :
      </div>
      ...
      >
        {`import * as webLLM from 'botconversa-chat-web-llm'`}
        <br />
