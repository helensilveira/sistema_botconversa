...
See the [External Modules](/examples/externalModules) section on how to integrate the [`botconversa-chat-web-llm`](https://github.com/botconversa/web-llm) module into your project.
Then proceed with using the [`webModel`](#webModel) property:

### `webModel` {#webModel}

- Type: `true` | \{ <br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`model?: string`](https://github.com/botconversa//blob/10db3f4931d7fefff81e1c93d38a9a9809701113/component/src/types/webModel/webModel.ts#L1), <br />
...
`model` is the name of the model to be used. See [full list](https://github.com/botconversa//blob/10db3f4931d7fefff81e1c93d38a9a9809701113/component/src/types/webModel/webModel.ts#L1). <br />
...
import botConversaBrowser from '@site/src/components/table/botConversaBrowser';
...
<ComponentContainer>
  <botConversaBrowser style={{borderRadius: '8px'}} webModel={true}></botConversaBrowser>
</ComponentContainer>
...
```html
<botconversa-chat webModel="true"></botconversa-chat>
```
...
<botconversa-chat webModel="true" style="border-radius: 8px"></botconversa-chat>
```
...
botconversa Chat uses the [`webModelConfig.ts`](https://github.com/botconversa//blob/284bc845de8bcefe8ef36b2ee1b79079e6978593/component/src/webModel/webModelConfig.ts) file to determine where the `model` and the `wasm` files will be downloaded from.
...
<ComponentContainer>
  <botConversaBrowser style={{borderRadius: '8px'}} webModel={{load: {onMessage: true}}}></botConversaBrowser>
</ComponentContainer>
...
```html
<botconversa-chat webModel='{"load": {"onMessage": true}}'></botconversa-chat>
```
...
<botconversa-chat webModel='{"load": {"onMessage": true}}' style="border-radius: 8px"></botconversa-chat>
```
...
Create a [`worker.js`](https://github.com/botconversa//blob/f0c0c5b1ae8d44a3eb51ab1d46345e338e4a23b4/website/docs/docs/worker.js) (or `worker.ts`) file in the same folder - which contains the following code:
...
- Use the following syntax to import [`botconversa-chat-web-llm`](https://github.com/botconversa/web-llm) instead:
...
If you are still experiencing issues, please see [**github issues**](https://github.com/botconversa//issues) or create
a [**new issue ticket**](https://github.com/botconversa//issues/new) and we will look into
it as soon as possible.

## Thankyou

The [`botconversa-chat-web-llm`](https://github.com/botconversa/web-llm) module is a fork based on the [`mlc-ai/web-llm`](https://github.com/mlc-ai/web-llm) repository.
