...
Method properties that can be called directly on the botconversa Chat element.

:::info
Make sure the botconversa Chat component has been fully rendered on the DOM before using these.
:::
