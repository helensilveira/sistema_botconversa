...
```html
<botconversa-chat images="true"></botconversa-chat>
```
...
```html
<botconversa-chat gifs="true"></botconversa-chat>
```
...
```html
<botconversa-chat camera="true"></botconversa-chat>
```
...
```html
<botconversa-chat audio="true"></botconversa-chat>
```
...
```html
<botconversa-chat microphone="true"></botconversa-chat>
```
...
```html
<botconversa-chat mixedFiles="true"></botconversa-chat>
```
...
```html
<botconversa-chat dragAndDrop='{"backgroundColor": "#80ff704d", "border": "5px dashed #52c360"}'></botconversa-chat>
```
...
```html
<botconversa-chat images='{"files": {"maxNumberOfFiles": 2, "acceptedFormats": ".jpg,.png"}}'></botconversa-chat>
```
