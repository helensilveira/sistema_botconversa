...
Insert your markup between the botconversa Chat element tags and the component will render it inside the intro panel.
...
<ComponentContainer>
  <botconversaChatBrowser style={{borderRadius: '8px'}} demo={true}>
    <div
      style={{
        width: '200px',
...
<botconversa-chat demo="true" style="border-radius: 8px">
  <div
    style="
      width: 200px;
      background-color: #f3f3f3;
...
Because botconversa Chat is a [shadow element](https://developer.mozilla.org/en-US/docs/Web/API/Web_components/Using_shadow_DOM) - the intro panel will not have access
...
<botconversa-chat id="chat-element">
...
<botconversa-chat id="chat-element" style="height: 370px; border-radius: 8px">
  <div style="display: none">
    <div class="custom-button">
      <div class="custom-button-text">"Explain quantum computing"</div>
    </div>
...
:::tip
To remove an automatically generated panel - add empty `div` tags: `<botconversa-chat><div></div></botconversa-chat>` .
:::
