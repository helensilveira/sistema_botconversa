...
botconversa Chat is preconfigured to connect to popular AI APIs right out of the box. <br /> Depending on the service you choose component assets
...
property to connect to your server. Read more about this in [`Connect`](../connect) and check [examples](https://botconversachat.dev/examples/servers).
:::
...
Read more about this in [`Connect`](../connect) and check [examples](https://botconversachat.dev/examples/servers).
:::
