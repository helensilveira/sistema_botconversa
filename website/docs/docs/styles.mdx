...
<ComponentContainer>
  <botConversaBrowser style={{backgroundColor: '#f7f7f7', borderRadius: '8px'}} demo={true}></botConversaBrowser>
</ComponentContainer>
...
```html
<botconversa-chat style="background-color: #f7f7f7; border-radius: 8px"></botconversa-chat>

<botconversa-chat chatStyle='{"backgroundColor": "#f7f7f7", "borderRadius": "8px"}'></botconversa-chat>
```
...
<botconversa-chat style="background-color: #f7f7f7; border-radius: 8px" demo="true"></botconversa-chat>

<botconversa-chat chatStyle='{"backgroundColor": "#f7f7f7", "borderRadius": "8px"}' demo="true"></botconversa-chat>
```
...
```html
<botconversa-chat attachmentContainerStyle='{"backgroundColor": "#b2e1ff57"}'></botconversa-chat>
```
...
```html
<botconversa-chat inputAreaStyle='{"backgroundColor": "#ebf5ff"}'></botconversa-chat>
```
...
<botconversa-chat inputAreaStyle='{"backgroundColor": "#ebf5ff"}' style="border-radius: 8px" demo="true"></botconversa-chat>
```
