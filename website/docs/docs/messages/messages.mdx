...
`html` is used to render [custom code](/docs/messages/HTML) and can be coupled with a [`botconversa-chat-temporary-message`](/docs/messages/HTML#botconversaChatClasses)
...
```html
<botconversa-chat introMessage='{"text": "Hi I am your assistant, ask me anything!"}'></botconversa-chat>
```
...
```html
<botconversa-chat avatars="true"></botconversa-chat>
```
...
```html
<botconversa-chat names="true"></botconversa-chat>
```
...
```html
<botconversa-chat displayLoadingBubble="false"></botconversa-chat>
```
...
botconversa Chat automatically displays an error message when something goes wrong. This object is used to control what the message will contain. <br />
