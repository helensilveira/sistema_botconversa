...
<video className="documentation-video" controls>
  <source src="https://github.com/botconversa//assets/18709577/e103a42e-b3a7-4449-b9db-73fed6d7876e" />
</video>
...
```html
<botconversa-chat textToSpeech='{"volume": 0.9}'></botconversa-chat>
```
...
:::info
Speech to text functionality is provided by the [`Speech To Element`](https://github.com/botconversa/speech-to-element) library.
:::
...
```html
<botconversa-chat speechToText='{"webSpeech": {"language": "en-US"}}'></botconversa-chat>
```
...
:::note
This service stops after a brief period of silence due to limitations in its API and not botconversa Chat.
:::
...
and [starter server templates](https://github.com/botconversa/speech-to-element/tree/main/examples). <br />
...
please switch to using the `retrieveToken` property. Check out the example below and [starter server templates](https://github.com/botconversa/speech-to-element/tree/main/examples).
...
```html
<botconversa-chat speechToText='{"textColor": {"interim": "green", "final": "blue"}}'></botconversa-chat>
```
...
This is the example used in the [demo video](https://github.com/botconversa//assets/18709577/e103a42e-b3a7-4449-b9db-73fed6d7876e). When replicating - make sure
