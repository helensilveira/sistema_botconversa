...
To keep botconversa Chat as lightweight as possible, some of its functionality requires the use of external modules.
...
| LLM [web model](/docs/webModel#webModel)                                            | <WebModelLogo width="18" style={{float: 'left', marginRight: '6px', marginTop: '4.5px'}} className="adaptive-logo-filter"/>[botconversa-chat-web-llm](https://github.com/botconversa/web-llm)                    | `window.webLLM`    |
...
- <b>Import from a dependancy</b> <br />
  ...
  | [web model](https://www.npmjs.com/package/microsoft-cognitiveservices-speech-sdk) | import \* as webLLM from 'botconversa-chat-web-llm' <br /> window.webLLM = webLLM;                    |
...
- <b>Dynamic import from a dependancy (recommended for SSR)</b> <br />
  ...
  | [web model](https://github.com/botconversa/web-llm)                      | import('botconversa-chat-web-llm').then((module) => \{ <br /> &nbsp;&nbsp;&nbsp;&nbsp; window.webLLM = module; <br /> \});                                                                                                              |
...
- <b>Script from a CDN</b> <br />
  ...
  | [web model](https://github.com/botconversa/web-llm)                      | const script = document.createElement('script'); <br /> script.src = 'https://cdn.jsdelivr.net/gh/botconversa/web-llm/lib/index.js'; <br /> document.body.appendChild(script);                                                                                                                   |
...
[Click for Live Example](https://codesandbox.io/s/botconversa-chat-vanillajs-external-modules-fgw5k5?file=/index.html)
...
First, the post-compression size of the above modules is orders of magnitude bigger than botconversa Chat. This
...
seemed promising, but unfortunatelly we hit a roadblock that had no simple way of overcoming; botconversa Chat itself is an injectable component that
...
Therefore, to make the lives of our developers as simple as possible; for use cases that do not need the extra functionality - botconversa Chat can
...
If you are experiencing issues for importing/exporting files, please see [**github issues**](https://github.com/botconversa//issues) or create
