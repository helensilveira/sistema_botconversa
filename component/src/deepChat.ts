...
import style from './botconversaChat.css?inline';
...
export class botconversaChat extends InternalHTML {
  @Property('object')
  connect?: Connect;
  ...
  @Property('function')
  onComponentRender?: (ref: botconversaChat) => void;
