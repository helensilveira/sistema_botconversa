...
export class TextInputEl {
  ...
  constructor(botconversaChat: botconversaChat, serviceIO: ServiceIO) {
    const processedConfig = TextInputEl.processConfig(serviceIO, botconversaChat.textInput);
    ...
    setTimeout(() => {
      // in a timeout as botconversaChat._validationHandler initialised later
      TextInputEvents.add(this.inputElementRef, botconversaChat.textInput?.characterLimit, botconversaChat._validationHandler);
    });
  }
