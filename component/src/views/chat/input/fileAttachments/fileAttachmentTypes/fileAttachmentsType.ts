...
export class FileAttachmentsType {
  ...
  // prettier-ignore
  constructor(botconversaChat: botconversaChat, fileAttachments: FileAttachments, toggleContainer: (display: boolean) => void,
    ...
    setTimeout(() => {this._validationHandler = botconversaChat._validationHandler;});
  }
