...
export class FileAttachments {
  ...
  // prettier-ignore
  addType(botconversaChat: botconversaChat, files: FileAttachmentsT, type: keyof ServiceFileTypes) {
    const fileAttachmentsType = FileAttachmentTypeFactory.create(
      botconversaChat, files, this.toggleContainerDisplay.bind(this), this.elementRef, type);
