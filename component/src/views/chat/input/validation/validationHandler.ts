...
export class ValidationHandler {
  ...
  // prettier-ignore
  public static attach(botconversaChat: botconversaChat, serviceIO: ServiceIO, textInput: TextInputEl,
      fileAttachments: FileAttachments, submitButton: SubmitButton) {
    const validateInput = botconversaChat.validateInput || Legacy.processValidateInput(botconversaChat);
    botconversaChat._validationHandler = async (programmatic?: UserContentI) => {
