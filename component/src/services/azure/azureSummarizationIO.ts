...
export class AzureSummarizationIO extends AzureLanguageIO {
  ...
  constructor(botconversaChat: botconversaChat) {
    const config = botconversaChat.directConnection?.azure?.summarization as NonNullable<Azure['summarization']>;
    const apiKey = botconversaChat.directConnection?.azure;
    super(botconversaChat, AzureUtils.buildSummarizationHeader, config.endpoint, apiKey);
