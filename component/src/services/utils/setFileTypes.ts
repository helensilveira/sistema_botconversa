...
export class SetFileTypes {
  ...
  private static processMixedFiles(serviceIO: ServiceIO, remark: Remarkable, mixedFiles: botconversaChat['mixedFiles']) {
    if (mixedFiles) {
  ...
  private static processMicrophone(
    serviceIO: ServiceIO, remark: Remarkable, microphone: botconversaChat['microphone'], audio: botconversaChat['audio']) {
  ...
  private static processAudioConfig(
      serviceIO: ServiceIO, remark: Remarkable, audio: botconversaChat['audio'], fileIO?: FileServiceIO) {
  ...
  private static processGifConfig(
      serviceIO: ServiceIO, remark: Remarkable, gifs: botconversaChat['gifs'], fileIO?: FileServiceIO) {
  ...
  private static processCamera(
      serviceIO: ServiceIO, remark: Remarkable, camera: botconversaChat['camera'], images?: botconversaChat['images']) {
  ...
  private static processImagesConfig(
      serviceIO: ServiceIO, remark: Remarkable, images: botconversaChat['images'], fileIO?: FileServiceIO) {
  ...
  public static set(botconversaChat: botconversaChat, serviceIO: ServiceIO, existingFileTypes?: ServiceFileTypes) {
    ...
    SetFileTypes.processImagesConfig(serviceIO, remarkable, botconversaChat.images, existingFileTypes?.images);
    SetFileTypes.processCamera(serviceIO, remarkable, botconversaChat.camera, botconversaChat.images);
    SetFileTypes.processGifConfig(serviceIO, remarkable, botconversaChat.gifs, existingFileTypes?.gifs);
    SetFileTypes.processAudioConfig(serviceIO, remarkable, botconversaChat.audio, existingFileTypes?.audio);
    SetFileTypes.processMicrophone(serviceIO, remarkable, botconversaChat.microphone, botconversaChat.audio);
    SetFileTypes.processMixedFiles(serviceIO, remarkable, botconversaChat.mixedFiles);
  }
}
