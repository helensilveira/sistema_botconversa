...
export class HuggingFaceFileIO extends HuggingFaceIO {
  ...
  // prettier-ignore
  constructor(botconversaChat: botconversaChat, placeholderText: string, defaultModel: string,
      config: true | (HuggingFaceModel), apiKey?: APIKey, existingFileTypes?: ServiceFileTypes) {
    super(botconversaChat, placeholderText, defaultModel, config, apiKey, existingFileTypes);
