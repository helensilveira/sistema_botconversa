...
export class AssemblyAIAudioIO extends DirectServiceIO {
  ...
  constructor(botconversaChat: botconversaChat) {
    const apiKey = botconversaChat.directConnection?.assemblyAI;
    super(botconversaChat, AssemblyAIUtils.buildKeyVerificationDetails(), AssemblyAIUtils.buildHeaders, apiKey, {audio: {}});
