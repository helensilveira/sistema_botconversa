...
export class RequestUtils {
  ...
  public static async processRequestInterceptor(botconversaChat: botconversaChat, requestDetails: RequestDetails): InterceptorResultP {
    const result = (await botconversaChat.requestInterceptor?.(requestDetails)) || requestDetails;
