![botconversa Chat](../../../assets/readme/express-connect.png)

This is an example Express server template that can be used to communicate with the [botconversa Chat](https://www.npmjs.com/package/botconversa-chat) component. It includes a variety of endpoints that can be used to host your own service or act as a proxy for the following AI APIs - [OpenAI](https://openai.com/blog/openai-api), [HuggingFace](https://huggingface.co/docs/api-inference/index), [StabilityAI](https://stability.ai/), [Cohere](https://docs.cohere.com/docs).
