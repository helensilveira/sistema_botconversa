// import {botconversaChat as botconversaChatCore} from 'botconversa-chat'; <- type
import {RequestDetails} from 'botconversa-chat/dist/types/interceptors';
import styles from '../styles/Index.module.css';
import dynamic from 'next/dynamic';

// Info to get a reference for the component:
// https://github.com/botconversa//issues/59#issuecomment-1839483469

// Info to add types to a component reference:
// https://github.com/botconversa//issues/59#issuecomment-1839487740
...
export default function IndexPage() {
  ...
  const botconversaChat = dynamic(() => import('botconversa-chat-react').then((mod) => mod.botconversaChat), {
    ssr: false,
  });
    ...
    <>
      <main className={styles.main}>
        <h1 id={styles.pageTitle}>
          botconversa Chat test ground for{' '}
          <a href="https://github.com/botconversa//tree/main/example-servers/nextjs">NextJs</a>
        </h1>
        ...
        <div className={styles.components}>
          ...
          {/* by setting maxMessages requestBodyLimits to 0 or lower - each request will send full chat history:
            https://botconversachat.dev/docs/connect/#requestBodyLimits */}
          {/* If you don't want to or can't edit the target service, you can process the outgoing message using
            ...
            https://botconversachat.dev/docs/interceptors */}
          <botconversaChat
        ...
        <a href="https://openai.com/blog/openai-api" target="_blank" rel="noreferrer">
          <img
            ...
            src="https://raw.githubusercontent.com/botconversa//HEAD/website/static/img/openAILogo.png"
        ...
        <div className={styles.components}>
          ...
          {/* If not using the camera, you can use an example image here:
            https://github.com/botconversa//blob/main/example-servers/ui/assets/example-image.png */}
          <botconversaChat
            style={{borderRadius: '10px'}}
            introMessage={{
        ...
        <a href="https://huggingface.co/docs/api-inference/index" target="_blank" rel="noreferrer">
          <img
            className={styles.serverTitleIcon}
            src="https://raw.githubusercontent.com/botconversa//HEAD/website/static/img/huggingFaceLogo.png"
        ...
        <div className={styles.components}>
          ...
          {/* If not using the microphone, you can send an example audio file here:
            https://github.com/botconversa//blob/main/example-servers/ui/assets/example-audio.m4a */}
          <botconversaChat
            style={{borderRadius: '10px'}}
            introMessage={{
        ...
        <a href="https://platform.stability.ai/" target="_blank" rel="noreferrer">
          <img
            ...
            src="https://raw.githubusercontent.com/botconversa//HEAD/website/static/img/stabilityAILogo.png"
        ...
        <a href="https://docs.cohere.com/docs" target="_blank" rel="noreferrer">
          <img
            className={styles.serverTitleIcon}
            src="https://raw.githubusercontent.com/botconversa//HEAD/website/static/img/cohereLogo.png"
