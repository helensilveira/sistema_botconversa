<script>
  /**
   * @type {import('botconversa-chat/dist/types/interceptors').RequestDetails}
  */
  let RequestDetails;
...
<main class='app'>
  {#if isLoaded}
    <h1 id="page-title">
      ...
      <a href="https://github.com/botconversa//tree/main/example-servers/sveltekit">SvelteKit</a>
    </h1>
