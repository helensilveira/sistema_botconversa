...
public class CustomService {
  ...
  public botconversaChatTextRespose chat(botconversaChatRequestBody requestBody) {
    ...
    return new botconversaChatTextRespose("This is a response from a Java server. Thank you for your message!");
  }

  public void chatStream(botconversaChatRequestBody requestBody, HttpServletResponse response) throws IOException {
    // Text messages are stored inside request body using the botconversa Chat JSON format:
    // https://botconversachat.dev/docs/connect
    LOGGER.info("Received request body: {}", PrintObjectUtil.toJsonString(requestBody));
  ...
  public botconversaChatTextRespose files(@RequestPart("files") List<MultipartFile> files, Map<String, String> formDataProperties) {
