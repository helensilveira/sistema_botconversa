...
public class StabilityAIService {
  ...
  public botconversaChatFileResponse textToImage(botconversaChatRequestBody requestBody) throws Exception {
    ...
    return new botconversaChatFileResponse(Arrays.asList(new botconversaChatFile(base64, "image")));
  }
  
  // You can use an example image here: https://github.com/botconversa//blob/main/example-servers/ui/assets/example-image.png
  public botconversaChatFileResponse imageToImage(@RequestPart("files") List<MultipartFile> files, Map<String, String> formDataProperties) throws Exception {
