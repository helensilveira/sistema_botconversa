...
public class HuggingFaceService {
  ...
  public botconversaChatTextRespose conversation(botconversaChatRequestBody requestBody) throws Exception {
    ...
    return new botconversaChatTextRespose(responseBody.getGeneratedText());
  }

  private static HuggingFaceConversationBody createConversationBody(botconversaChatRequestMessage[] messages) {
  ...
  public botconversaChatTextRespose imageClassification(@RequestPart("files") List<MultipartFile> files) throws Exception {
    ...
    // Sends response back to botconversa Chat using the Response format:
    // https://botconversachat.dev/docs/connect/#Response
    return new botconversaChatTextRespose(responseData[0].getLabel());
  }

  // You can use an example audio file here: https://github.com/botconversa//blob/main/example-servers/ui/assets/example-audio.m4a
  public botconversaChatTextRespose speechRecognition(@RequestPart("files") List<MultipartFile> files) throws Exception {
    ...
    // Sends response back to botconversa Chat using the Response format:
    // https://botconversachat.dev/docs/connect/#Response
    return new botconversaChatTextRespose(responseData.getText());
  }
}
