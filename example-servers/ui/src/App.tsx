...
import {botconversaChat} from 'botconversa-chat-react';
import './App.css';
  ...
  return (
    <div className="App">
      <h1 id="page-title">
        ...
        <a href="https://github.com/botconversa//tree/main/example-servers">Example Servers</a>
      </h1>
      ...
      <div className="components">
        ...
        {/* additionalBodyProps is used to set other properties that will be sent to the server along with the message:
            https://botconversachat.dev/docs/connect#request */}
        {/* by setting maxMessages requestBodyLimits to 0 or lower - each request will send full chat history:
            https://botconversachat.dev/docs/connect/#requestBodyLimits */}
        <botconversaChat
          style={{borderRadius: '10px'}}
