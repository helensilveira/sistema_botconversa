...
func CreateTextResponse(w http.ResponseWriter, text string) ([]byte, error) {
	// Create a response to botconversa Chat using the Response format:
	// https://botconversachat.dev/docs/connect/#Response
	response := botconversaChatTextResponse{
		Text: text,
	}
...
func CreateImageResponse(w http.ResponseWriter, src string) ([]byte, error) {
	// Create a response to botconversa Chat using the Response format:
	// https://botconversachat.dev/docs/connect/#Response
	response := botconversaChatFileResponse{
...
func createErrorResponse(w http.ResponseWriter, text string) ([]byte, error) {
	// Create a response to botconversa Chat using the Response format:
	// https://botconversachat.dev/docs/connect/#Response
	response := botconversaChatErrorResponse{
		Error: text,
	}
