...
type botconversaChatRequestBody struct {
	Messages []botconversaChatRequestMessage `json:"messages"`
	Model string `json:"model"`
	Stream bool `json:"stream"`
}

type botconversaChatRequestMessage struct {
	Role string `json:"role"`
	Text string `json:"text"`
}

type botconversaChatTextResponse struct {
	Text string `json:"text"`
}

type botconversaChatFileResponse struct {
...
type botconversaChatErrorResponse struct {
