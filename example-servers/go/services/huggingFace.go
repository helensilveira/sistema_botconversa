...
func createConversationRequestBodyBytes(w http.ResponseWriter, r *http.Request) ([]byte, error) {
	...
	conversationBody := createConversationBody(botconversaChatRequestBody.Messages)
	fmt.Println(conversationBody)
	return json.Marshal(conversationBody)
}

func createConversationBody(messages []botconversaChatRequestMessage) HuggingFaceConversationBody {
...
// You can use an example audio here: https://github.com/botconversa//blob/main/example-servers/ui/assets/example-audio.m4a
